...
export const LeetcodeIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.17 5.79a1.374 1.374 0 0 0-.416.973V17.2a1.374 1.374 0 0 0 .416.973l5.352 5.352a1.374 1.374 0 0 0 1.922 0l7.28-7.28a1.374 1.374 0 0 0 0-1.922l-5.352-5.352a1.374 1.374 0 0 0-.961-.438zM16 11.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
  </svg>
);
